			...
			<div className="w-screen h-[80] z-10 bg-dark fixed drop-shadow-lg p-2">
				<div className="px-2 flex justify-between items-center w-full h-full">
					<div className="flex items-center">
						<img src={logo} alt="bitcoin-icon" className="w-12 ml-4"></img>
						<h1 className="text-3xl font-bold mx-4 sm:text-4xl text-white">Bcoin.</h1>
						<ul className="text-white hidden md:flex mx-10">
				...
				<div className={!nav ? "hidden" : "object-left flex lg:hidden absolute top-7 right-40 px-10 pr-40 py-9"}>
